...
namespace Devdog.InventorySystem
{
    ...
    public partial class InventoryLangDatabase : ScriptableObject
    {
        ...
        public InventoryNoticeMessage itemCannotBeUsedToLowProperty = new InventoryNoticeMessage("", "Item {0} cannot be used {2} is to low", NoticeDuration.Medium, Color.white);
        public InventoryNoticeMessage itemCannotBeUsedPropertyNotValid = new InventoryNoticeMessage("", "Item {0} cannot be used {2} is to high or to low", NoticeDuration.Medium, Color.white);
        ...
        [InventoryEditorCategory("Triggerers")]
        public InventoryNoticeMessage triggererCantBeUsedMissingItems = new InventoryNoticeMessage("", "{0} can't be used. Missing {1}", NoticeDuration.Medium, Color.white);
        public InventoryNoticeMessage triggererCantBeUsedFailedPropertyRequirements = new InventoryNoticeMessage("", "{0} can't be used. {1} is to high or to low", NoticeDuration.Medium, Color.white);
        ...
        public InventoryNoticeMessage craftingCannotPropertyNotValid = new InventoryNoticeMessage("", "Item {0} cannot be crafted {2} is to high or to low", NoticeDuration.Medium, Color.white);
