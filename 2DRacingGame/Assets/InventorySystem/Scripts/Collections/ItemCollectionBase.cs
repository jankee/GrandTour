...
namespace Devdog.InventorySystem
{
    ...
    public partial class ItemCollectionBase : MonoBehaviour, IEnumerable, IEnumerable<InventoryUIItemWrapperBase>
    {
        ...
        private ItemCollectionBaseAddCounter counter = new ItemCollectionBaseAddCounter();
        ...
        {
            var lookup = new ItemCollectionBaseAddCounter.CollectionLookup(this);
            counter.LoadFrom(this);
            return counter.CanAddItemCount(lookup, itemToAdd);
        }
        ...
        public virtual bool AddItems(IEnumerable<InventoryItemBase> items,
...
//            var items = FindAll(itemID);
        ...
        public virtual bool MoveItem(InventoryItemBase item, uint fromSlot, ItemCollectionBase toCollection, uint toSlot, bool clearOld, bool doRepaint = true)
        {
            ...
            toCollection.SetItem(toSlot, item, doRepaint);
            if (clearOld)
                SetItem(fromSlot, null, doRepaint);
