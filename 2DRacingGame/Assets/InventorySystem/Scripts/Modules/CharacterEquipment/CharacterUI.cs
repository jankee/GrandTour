    ...
    public partial class CharacterUI : ItemCollectionBase, ICollectionPriority, IInventoryDragAccepter
    {
        ...
        public override void Awake()
        {
            ...
            for (int i = 0; i < items.Length; i++)
            {
                ...
                Assert.IsNotNull(equipSlotFields[i], "CharacterUI manually defineid collection contains gameObject without InventoryEquippableField component.");
        ...
        {
            stats.dataProviders.Add(new InventoryStatsPropertiesDataProvider(this));
            stats.dataProviders.Add(new InventoryStatsDataProvider(this));
        }
        ...
        public override void NotifyItemAdded(IEnumerable<InventoryItemBase> items, uint amount, bool cameFromCollection)
        {
            ...
            foreach (var item in items)
            {
                ...
                ((EquippableInventoryItem)item).EquippedItem(equipSlotFields[item.index], this, amount);
            }
        }
