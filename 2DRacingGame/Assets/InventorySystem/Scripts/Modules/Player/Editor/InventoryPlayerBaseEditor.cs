...
namespace Devdog.InventorySystem.Editors
{
    ...
    public class InventoryPlayerBaseEditor : InventoryEditorBase
    {
        ...
        protected SerializedProperty characterUIPath;
        protected SerializedProperty inventoryPaths;
        protected SerializedProperty skillbarPath;
...
//        }
        ...
        public override void OnEnable()
        {
            ...
            inventoriesList = new ReorderableList(serializedObject, inventoryPaths, false, true, true, true);
            ...
            inventoriesList.drawElementCallback += (rect, index, active, focused) =>
            {
                ...
                EditorGUI.PropertyField(rect, inventoryPaths.GetArrayElementAtIndex(index));
