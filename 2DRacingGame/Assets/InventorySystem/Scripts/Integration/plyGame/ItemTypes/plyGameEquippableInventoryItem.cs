...
//        }
        ...
        public override void EquippedItem(InventoryEquippableField equipSlot, CharacterUI equipTo, uint amountEquipped)
        {
            base.EquippedItem(equipSlot, equipTo, amountEquipped);
