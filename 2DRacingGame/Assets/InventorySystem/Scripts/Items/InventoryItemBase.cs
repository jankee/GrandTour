...
namespace Devdog.InventorySystem
{
    ...
    public partial class InventoryItemBase : MonoBehaviour
    {
        ...
        public InventoryItemCategory category
        {
            get
            {
                return ItemManager.database.itemCategories.FirstOrDefault(o => o.ID == _category);
            }
            set
            {
                _category = value.ID;
        ...
        public InventoryItemRarity rarity
        {
            get
            {
                return ItemManager.database.itemRarities.FirstOrDefault(o => o.ID == _rarity);
            }
        }
        ...
        public virtual int Use()
        {
            ...
            if (isInCooldown)
            {
                InventoryManager.langDatabase.itemIsInCooldown.Show(name, description, (useCategoryCooldown ? category.lastUsageTime + category.cooldownTime : lastUsageTime + cooldownTime) - Time.timeSinceLevelLoad, (useCategoryCooldown ? category.cooldownTime : cooldownTime));
                return -1;
            }
