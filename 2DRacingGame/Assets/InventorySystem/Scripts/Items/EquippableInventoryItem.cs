...
namespace Devdog.InventorySystem
{
    ...
    public partial class EquippableInventoryItem : InventoryItemBase
    {
        ...
        public virtual void NotifyItemEquipped(InventoryEquippableField equipSlot, CharacterUI equipTo, uint amountEquipped)
        {
            equippedToPlayer = equipTo.player;
            Assert.IsNotNull(equippedToPlayer, "CharacterUI's player reference not set! Forgot to assign to player?");

            SetItemProperties(equipTo.player, InventoryItemUtility.SetItemPropertiesAction.Use);
...
//        [Obsolete("Use characterCollection.EquipItem() instead.")]
        public bool Equip(InventoryEquippableField equipSlot, CharacterUI equipTo)
        {
            return equipTo.EquipItem(equipSlot, this);
        }
...
//        [Obsolete("Use characterCollection.UnEquipItem() instead.")]
        ...
        public virtual void EquippedItem(InventoryEquippableField equipSlot, CharacterUI equipTo, uint amountEquipped)
        {
            NotifyItemEquipped(equipSlot, equipTo, amountEquipped);
        }
